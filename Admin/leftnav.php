...
<li>
                        ...
                        <a href="admin_table.php" class="waves-effect"> <i class="fa fa-table fa-fw" aria-hidden="true"></i>Admin</a>
                    </li>
	 ...
	 <li>
                        <a href="Teacher_table.php" class="waves-effect"> <i class="fa fa-table fa-fw" aria-hidden="true"></i>Teacher</a>
                    </li>
